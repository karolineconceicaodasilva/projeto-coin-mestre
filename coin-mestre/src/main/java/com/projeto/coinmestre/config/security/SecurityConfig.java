...
public class SecurityConfig {
    ...
    private static final String CLIENT_ID = "coin-mestre";
    private static final String CLIENT_SECRET = "backoffice-123456";
    private static final int TOKEN_VALIDITY = 43200;
    private static final String SCOPE = "all";
    private static final String RESOURCE_ID = "coin-mestre-service";
